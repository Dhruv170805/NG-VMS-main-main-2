...
router.post('/register', express.json({ limit: '10mb' }), validateRegisterVisitor, registerVisitor);
...
router.post('/:id/id-preview', express.json({ limit: '10mb' }), protect, authorize('ADMIN', 'GUARD'), updateIdProofPreview);
